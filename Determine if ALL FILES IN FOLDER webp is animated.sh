...
echo -------------------------========================-------------------------
	...
	echo 2023-03-29_Wednesday_08:30:56
	echo
## Software name, what is this, version, informations.
	echo "Software name: Convert/modify/rename or Informations"
	echo
	echo "What it does ?"
	echo "Convert/modify/rename to audio/video"
	echo
	echo "This is a software conversion"
	echo
...
## for 1 file
## echo $(grep -c "ANMF" "$file")

## for folder
part=$((part+1))
echo "-------------------------===== Section $part =====-------------------------"
echo "Finding files... (webp) only."
	echo
	rm "/dev/shm/findfiles.txt" 2> /dev/null
	...
	echo
	echo "Finding finish (webp only) , with file count :"
...
part=$((part+1))
echo "-------------------------===== Section $part =====-------------------------"
echo Search started of webp animated...
	echo
...
echo "Move files ?"
	...
	## A pattern to MOVE ONLY files matching something.
	awk '!/000_/' "/dev/shm/findaniwebp.txt" > /dev/shm/tmpfile.txt && mv /dev/shm/tmpfile.txt "/dev/shm/findaniwebp.txt"
	cat "/dev/shm/findaniwebp.txt"
	
	echo
	echo "Finding finish (webp only) , with file to move :"
	wc -l < "/dev/shm/findaniwebp.txt"
	echo
