...
echo -------------------------========================-------------------------
	...
	echo 2022-10-27_Thursday_06:22:37
	echo
...
echo "-------------------------===== Section $part =====-------------------------"
	...
	find $file -maxdepth 1 -iname '*.gif'  >> "/dev/shm/findfiles.txt"	#no animated gif UpScale
	...
	then
		...
		## convert to webp
			...
			do
				...
				convert "$line"_UpScale.jpg"" -format jpg -quality 95 "$line"_UpScale.jpg""
				done < "$input"
			}
		else
