...
echo -------------------------========================-------------------------
	...
	echo 2022-10-28_Friday_10:29:38
	echo
...
echo "-------------------------===== Section $part =====-------------------------"
	...
	echo UpScale, Conversion and move started...
	...
	#echo parallel -a "/dev/shm/findfiles.txt" -j $entry xbrzscale $entry2 {} {}_UpScale.webp
	#parallel -a "/dev/shm/findfiles.txt" -j $entry xbrzscale $entry2 {} {}_UpScale.webp
	echo parallel -a "/dev/shm/findfiles.txt" -j $entry xbrzscale $entry2 {} {}_UpScale.jpg
	parallel -a "/dev/shm/findfiles.txt" -j $entry xbrzscale $entry2 {} {}_UpScale.jpg
	echo UpScale finish...
...
echo "-------------------------===== Section $part =====-------------------------"
	...
	then
		...
		echo "-------------------------===== Section $part =====-------------------------"
			...
			find $file -maxdepth 1 -iname '*UpScale.jpg'  >> "/dev/shm/findfiles.txt"
		...
		echo "-------------------------===== Section $part =====-------------------------"
			...
			parallel -a "/dev/shm/findfiles.txt" -j $defi mogrify -verbose -format jpg -quality 95	## jpg
			error $?
	else
		part=$((part+1))
		echo "-------------------------===== Section $part =====-------------------------"
...
## Move files to new folder.
	...
	if zenity --question --text="Do you want to move files to $HOME/Downloads/UpScale ? (Yes or No))"
	then
		part=$((part+1))
		echo "-------------------------===== Section $part =====-------------------------"
		echo Create folder.
		mkdir -p "$file/UpScale"
		echo /home/master/Downloads/*_UpScale* $file/UpScale
		mv /home/master/Downloads/*_UpScale* $file/UpScale
	else
		part=$((part+1))
		echo "-------------------------===== Section $part =====-------------------------"
