...
## Software lead-in
	...
	echo 2022-02-04_Friday_10:18:45
echo -------------------------========================-------------------------
...
echo "Code start"
	...
	echo "-------------------------===== Section $part =====-------------------------"
	echo "Copy files"
	echo cp "$file" "$name"-1920x1080.jpg
	echo cp "$file" "$name"-4k.jpg
	echo cp "$file" "$name"-8k.jpg
	cp "$file" "$name"-1920x1080.jpg
	cp "$file" "$name"-4k.jpg
	cp "$file" "$name"-8k.jpg
		error $?
	...
	part=$((part+1))
	echo "-------------------------===== Section $part =====-------------------------"
	echo "Reseize to correct width (height ignored)"
	echo mogrify -resize '1920' "$name"-1920x1080.jpg
	echo mogrify -resize '3840' "$name"-4k.jpg
	echo mogrify -resize '7680' "$name"-8k.jpg
	mogrify -resize '1920' "$name"-1920x1080.jpg
	mogrify -resize '3840' "$name"-4k.jpg
	mogrify -resize '7680' "$name"-8k.jpg
		error $?
	
	part=$((part+1))
	echo "-------------------------===== Section $part =====-------------------------"
	echo "Crop to the good height"
	echo convert "$name"-1920x1080.jpg -gravity center -crop '0x1080+0-0' +repage "$name"-1920x1080.jpg
	echo convert "$name"-4k.jpg -gravity center -crop '0x2160+0-0' +repage "$name"-4k.jpg
	echo convert "$name"-8k.jpg -gravity center -crop '0x4320+0-0' +repage "$name"-8k.jpg
	convert "$name"-1920x1080.jpg -gravity center -crop '0x1080+0-0' +repage "$name"-1920x1080.jpg
	convert "$name"-4k.jpg -gravity center -crop '0x2160+0-0' +repage "$name"-4k.jpg
	convert "$name"-8k.jpg -gravity center -crop '0x4320+0-0' +repage "$name"-8k.jpg
		error $?
